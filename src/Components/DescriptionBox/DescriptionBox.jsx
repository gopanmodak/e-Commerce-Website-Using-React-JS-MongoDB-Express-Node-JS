  ...
  return (
    <div className='descriptionbox'>
      <div className="descriptionbox-navigator">
        ...
        <div className="descriptionbox-nav-box fade">Reviews (213)</div>
      </div>
...
<p>  An e-commerce website is an online platform that facilitates the buying
          ...
          (e.g., size, color). Each product usually has its own dedicated page
          with all relevant information.</p>
</div>
    </div>
  )
}
